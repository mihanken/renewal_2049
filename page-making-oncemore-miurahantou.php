<?php
    /**
    * Template Name: making-oncemore-miurahantou page
    */
?>
...
<div class="works-single__wrapper">
  ...
  <div class="works-single__container">
    <div class="works-single__container__content">
      <iframe src="https://www.youtube.com/embed/tjQY8bnEGCs" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen>
      </iframe>
    </div>
    <div class="works-single__container__txt text">
      <p>
        三浦半島研究会を卒業するメンバーに向けて制作した楽曲「once more 三浦半島」。
      </p>
      <p>
        今作の収録、撮影風景をまとめたメイキングも同時に制作しました。
      </p>
    </div>
