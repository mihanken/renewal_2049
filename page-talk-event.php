...
<div class="works-single__wrapper">
  ...
  <div class="works-single__container">
    <div class="works-single__container__content">
      <img src="<?php echo home_url(); ?>/wp-content/themes/mihanken/images/talk-event.jpg" alt="トークイベント「自分の仕事は自分でつくる」">
    </div>
    <div class="works-single__container__txt text">
      <p>
        編集者として活躍するミネシンゴさん、武田俊さん、田中佑典さんを招いて横浜市立大学でトークイベントを行いました。
      </p>
      <p>
        30名ほどが参加しました。
      </p>
